; This is an emacs major mode for Alloy that does keyword coloring
; and indentation.
; Copyright (C) 2002 Allison L Waingold (skippy@mit.edu)
...
; To get Emacs to automatically start Alloy mode when an Alloy model
; is opened, place this file in a directory in the Emacs load path, and
; then add the following two lines to your .emacs file:
